...
from thresholded_metrics.constants import MODEL_METADATA
from thresholded_metrics.constants import S3_MODEL_INFERENCE_PREFIX
...
def model_alias_to_data_path(alias: str) -> str:
    ...
    return "/Users/diego/Develop/Workspaces/kolena/workspace/kolena/examples/thresholded_metrics/thresholded_metrics/coco-2014-val_prediction_attribution_2.0_transportation.csv"
